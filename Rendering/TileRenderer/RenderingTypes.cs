...
public struct GeoFeature : BaseShape
{
    ...
    public GeoFeature(ReadOnlySpan<Coordinate> c, MapFeatureData feature)
    {
        ...
        if (feature.RenderType == RenderType.GEOFEATURE_PLAIN)
        {
        ...
        else if (feature.RenderType == RenderType.GEOFEATURE_MOUNTAINS)
        {
            Type = GeoFeatureType.Mountains;
        }
        else if (feature.RenderType == RenderType.GEOFEATURE_DESERT)
        {
            Type = GeoFeatureType.Desert;
        }
        else if (feature.RenderType == RenderType.GEOFEATURE_WATER)
        {
